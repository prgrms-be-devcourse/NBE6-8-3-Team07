        ...
        <div className="fixed inset-0 bg-gradient-to-br from-orange-100 via-yellow-50 to-amber-100 flex justify-center items-center z-50">
          <div className="text-center">
            ...
            <div className="relative mb-8">
              ...
              {/* 마법 별들 */}
              <div className="absolute -top-4 -left-8 text-yellow-400 animate-bounce delay-100">
                ✨
              </div>
              <div className="absolute -top-6 right-4 text-orange-400 animate-bounce delay-300">
                ⭐
              </div>
              <div className="absolute top-2 -right-8 text-amber-400 animate-bounce delay-500">
                ✨
              </div>
              <div className="absolute -bottom-2 -left-4 text-yellow-500 animate-bounce delay-700">
                🌟
              </div>
              <div className="absolute -bottom-4 right-2 text-orange-300 animate-bounce delay-900">
                ✨
              </div>
            </div>
          ...
          <style jsx>{`
            ...
            @keyframes loading-text {
              0% {
                content: "상상의 나래를 펼치는 중...";
              }
              33% {
                content: "마법의 이야기를 짜는 중...";
              }
              66% {
                content: "특별한 모험을 준비하는 중...";
              }
              100% {
                content: "아름다운 동화를 완성하는 중...";
              }
            }
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-amber-100 transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed">
                          마지막 슬라이드에서 입력한 내용을 확인하고,{" "}
                          <span className="font-semibold text-amber-600 bg-amber-50 px-2 py-1 rounded-lg">
                            동화 만들기 버튼
                          </span>
                          을 눌러 나만의 동화를 완성할 수 있어요!
                        </p>
                      </div>
                    </div>
                  </div>
